...
fun ExploreScreenRefactored(
    viewModel: ExploreViewModelEnhanced = ExploreViewModelEnhanced(),
...
private fun ExploreContentRefactored(
    ...
    onVenueClick: (VenueUiModel) -> Unit,
    onVenueBookmark: (VenueUiModel) -> Unit,
    onSeeMoreClick: (VenueUiModel) -> Unit,
    onRefresh: () -> Unit,
    onLoadMore: () -> Unit,
    onRetry: () -> Unit,
    onClearFilters: () -> Unit,
...
private fun ErrorContentRefactored(
    ...
    val (title, message, primaryAction, secondaryAction) = when (error) {
